Extracted data of 5000+ movies from IMDB website using a python library called Scrapy. Random Forest model was fitted to predict movie rating and gain insights into the factors affecting them.
